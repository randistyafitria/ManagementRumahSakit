...
public class Global {
    ...
    public static void jadwalkanJanjiTemu(LinkedList<Dokter> daftarDokter, LinkedList<Pasien> daftarPasien, LinkedList<Resepsionis> daftarResepsionis, LinkedList<Ruangan> daftarRuangan) {
